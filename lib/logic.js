                    ...
                    return getAssetRegistry('org.se.exchange.Proposal')
                        .then(function (proposalRegistry) {
                            ...
                            if (proposalRequest.proposalType == 'FOR_BUY') {
                                // return checkParticipantUpdate(trader, traderRegistry);                                
...
function checkParticipantUpdate(trader, traderRegistry) {
    trader.balance += 50;
    return traderRegistry.update(trader)
        ...
        .then(function (err) {
            console.log('Error in updating trader balance : ', err);
        })
    ...
    .then(function(saleProposals){
        ...
        .then(function(){
            ...
            saleProposals.forEach(function(saleProposal){
                ...
                if(traders[seller.email]){
                    traders[seller.email].balance += amount;
                }else{
                    seller.balance += amount;
                    traders[seller.email]= seller;
                }
            ...
            .then(function(){
                ...
                console.log('Traders : ', traderList);
