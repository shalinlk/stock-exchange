                    ...
                    return getAssetRegistry('org.se.exchange.Proposal')
                        .then(function (proposalRegistry) {
                            ...
                            if (proposalRequest.proposalType == 'FOR_BUY') {
                                checkParticipantSave(trader, traderRegistry);                                
...
function checkParticipantSave(trader, traderRegistry){
    trader.balance += 50;
    console.log('Updating Trader Balance')
    traderRegistry.update(trader)
    .then(function(){
