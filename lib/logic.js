...
function tradersFromProposal(proposals){
...
function settleCounterProposal(proposal, counterProposal, proposalType, count, stockPrice){
    if(proposal.company.getIdentifier() != counterProposal.company.getIdentifier()){
        return //throw error; Cannot settle proposals
    }
    if(proposal.trader.getIdentifier() == counterProposal.trader.getIdentifier()){
...
function addBalance(trader, amount){
    return getTraderRegistry('org.se.exchange.Trader')
    .then(function (traderRegistry){
...
function addProposal(proposal){
    //fix : Better to introduce propodal id here
    return getAssetRegistry('org.se.exchange.Prposal')
    .then(function(proposalRegistry){
...
function closeProposalByCount(proposal, count){
    ...
    return getAssetRegistry('org.se.exchnage.Proposal')
    .then(function(proposalRegistry){
